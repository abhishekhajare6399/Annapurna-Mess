                            ...
                            <table class="table">
                                ...
                                <tbody style="border:2px solid black;padding:10px;"> <?php
                                    $search=mysqli_real_escape_string($con, $_POST['name']);
                                     $find = "SELECT * FROM user WHERE  messid ='$messid' and (name ='$search' or userid ='$search' or messtype ='$search' or time ='$search') ";
                                     ...
                                     while($row = mysqli_fetch_array($result))
                                       {
                                        ...
                                        <th scope="row"  style="color:red;"><?php echo $row['userid'];?></th>
                                        <?php }else { ?>
                                        <th scope="row"><?php echo $row['userid'];?></th>
                                        <?php } ?>

                                        <?php if($row['payment_status']=="Unpaid"){ ?>
                                        <th scope="row"  style="color:green;"><?php echo $row['name'];?></th>
                                        <?php }else { ?>
                                            ...
                                            <a data-id='<?php echo $row['userid']; ?>' class="userio"
                                                style="text-decoration: none;"><button type="button"
                                                    class="btn btn-success"><i class="fa fa-edit"
                                                        aria-hidden="true"></i>
                                                    Edit</button></a>
                                            <?php if($row['point'] == 0 || $row['end_date'] <= $date) { ?>
                                            <a data-id='<?php echo $row['userid']; ?>' class="userio"
                                                style="text-decoration: none;"><button type="button"
...
$sql = "Update user set start_date='$sdate' , end_date='$edate',messtype='$messtype' ,point ='$point',payment='$pay',payment_status='$payment_status' where userid='$userid' and messid = '$messid'";
}else{
...
date_default_timezone_set("Asia/Calcutta");
    ...
    $updatequery = "update user set name='$name',point='$point',mobile='$mobile',email='$email',address='$address',messtype='$messtype',time='$time',start_date='$sdate',end_date='$edate' ,payment='$pay',payment_status='$payment_status'where token='$token' and messid='$messid' ";
