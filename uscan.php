                ...
                <div class="hero-text">
                    <div class="hero-text-tablecell">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7" style="background-color: white">
                                <div style="width: 500px; position: relative; padding: 0px; border: 1px solid silver;"
                                    ...
                                    <div id="reader__scan_region"
                                        style="width: 100%; min-height: 100px; text-align: center;"></div>
                                            ...
                                            <div>
                                                ...
                                                <div id="reader__dashboard_section_fsr"
                                                    style="text-align: center; display: none;"><input
                                                        ...
                                                        disabled="" style="width: 200px;"><span>&nbsp; Select
                                                        Image</span></div>
                                            </div>
                        	...
                        	<a href="uscan_gethint.php?q=<?php echo $messid;?>"><button class="btn btn-warning">Mark Attendance</button></a>
