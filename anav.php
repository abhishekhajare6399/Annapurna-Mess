<div class="col-sm-10">
        ...
        <div class="well">
            <div class="row">
                ...
                <div class="col-sm-1" style="padding:5px;"><br>
                    <img src="<?php echo $logo?>" width="100%" height="50%">
                </div>
                <div class="col-sm-5" style="padding:20px;">
                    <h3 style="font-family:Serif;color:black;text-align:left;font-size:25px"><?php echo $name?></h3>
                </div>
                ...
                <div class="modal-body4">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputState">Mobile :</label>
                                <input type="number" name="mobile" class="form-control" id="inputMobilenumber"
    ...
    $emailquery =" select * from user where  messid='$messid' and (email ='$email' or mobile = '$mobile') ";
...
$subject = "$mess Account Activation Req:#$rand";
  ...
  * { margin: 0; padding: 0; }
  ...
  <body>
      ...
      <div id='identity'>
          ...
          <h2><a href='http://localhost/Mess%20Management/user/aactivation.php?token=$token&&messid=$messid'>Click here</a> to Activate your Account</h2>
            ...
            $insertquery ="insert into user(messid,userid,name,mobile,email,password,image,messtype,time,address,joining_date,start_date,end_date,point,payment,payment_status,token,mstatus,status) 
            values('$messid','$rands','$name','$mobile','$email','$cpass','$image','$messtype','$time','$address','$date','$sdate','$edate','$point','$pay','Paid','$token','Active','Inactive')";
  ...
  if($query1)
  {
    ...
    $upoint = $point-1;
    $updatequery = "update user set point='$upoint' where userid='$userid' and messtype='Non-Regular' and messid='$messid' ";
