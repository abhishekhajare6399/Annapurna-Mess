...
<form action="" method="POST">
    ...
    <input type="hidden" name="fullpayment" id="inputAddress" value="<?php echo $payment;?>">
        ...
        <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
                                ...
                                <select id="inputState" name="foodtype" class="form-control" required>
                                    <option><?php echo $foodtype;?></option>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="date" name="date" class="form-control" id="inputAddress" value="<?php echo $date;?>">
        </div>
    </div>
    </div>
