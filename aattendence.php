            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="aattendence.php"><i class="fas fa-calendar"
                                aria-hidden="true"></i>&nbsp;&nbsp; Todays Attendance</a></li>
        ...
        <div class="row content">
            <div class="col-sm-2 sidenav hidden-xs"><br><br><br>
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="aattendence.php"><i class="fas fa-calendar"
                                aria-hidden="true"></i>&nbsp;&nbsp; Todays Attendance</a></li><br>
                    <li><a href="aallmember.php"><i class="fa-solid fa-users-line"></i>&nbsp;&nbsp; All Member</a></li>
                    <br>
                    <li><a href="aorderhistory.php"><i class="fa fa-history" aria-hidden="true"></i>&nbsp;&nbsp;Order
                            History</a></li><br>
                        ...
                        <div class="container2">
                            <table class="table">
                                ...
                                <tbody style="border:2px solid black;padding:10px;"> <?php
                                  $find = "SELECT * FROM attendance WHERE messid ='$messid' and (name ='$search' or userid ='$search') and date ='$search_date' ";
                                ...
                                $query = "SELECT * FROM attendance where messid ='$messid' and date='$search_date' order by date DESC";
