...
<h3><?php echo $mess?> Admin</h3>
  <p>Login Your self With <?php echo $mess?></p>
...
<div class="row">
  ...
  <div class="form-group">
    <div class="form-check">
      ...
      <label class="form-check-label" for="gridCheck">
      Forgot Password <a href="aforgotpass1.php?messid=<?php echo $messid?>">Click </a> here.
      </label><br>
    </div>
  </div><br>
  <div class="row">
...
if(isset($_POST['submit']))
{
    ...
    $email_search =" select * from signupmess where email ='$email' and status='Active' and messid='$messid' ";
